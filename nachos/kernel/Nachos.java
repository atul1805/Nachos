...
import nachos.kernel.threads.TaskManagerDemo;
...
public class Nachos implements Runnable {
    ...
    public static FileSystemReal fileSystem;
    ...
    *	Start test programs, if appropriate.
	...
	if(options.FILESYS_STUB || options.FILESYS_REAL)
	    fileSystem = (FileSystemReal) FileSystem.init(diskDriver);
  ...
  public static void main(String args[]) {
      ...
      extendedNachosThread firstThread = new extendedNachosThread("FirstThread", new Nachos(args));
      
      int numQueues = Integer.parseInt(args[0]);
      int quantum = Integer.parseInt(args[1]);
      
      scheduler = new Scheduler(firstThread,numQueues,quantum);
